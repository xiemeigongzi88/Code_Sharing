...
w, loss_ridge, mse_ridge = ridge_regression(x_train, y_train,lambda_ridge,x_test, y_test, epsilon, lr)
...
w, loss_lasso, mse_lasso = lasso_regression(x_train, y_train,lambda_ridge,x_test, y_test, epsilon, lr, sign)
################################################################################
def plot_diag(loss, mse,label_loss):
    plt.plot(loss_ridge , color = 'blue', label = label_loss)
    plt.plot(mse_curve, color = 'red', label ='MSE')
    plt.xlabel('epochs')
    plt.ylabel('loss')
    plt.legend()
    plt.show()
